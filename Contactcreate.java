...
public class Contactcreate {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@formcontrolname=\"display_name\"]")).sendKeys("Srik");
		
		//sendkeys to contact person
		driver.findElement(By.xpath("//input[@formcontrolname=\"name\"]")).sendKeys("Sri o");
		
		//sendkeys to mobilenumber
		driver.findElement(By.xpath("//input[@formcontrolname=\"mobile_number\"]")).sendKeys("8147436875");
		
		//sendKeys to Email field
		driver.findElement(By.xpath("//input[@formcontrolname=\"email_id\"]")).sendKeys("chikoo@gmail.com");
	  ...
	  //click on the Address 
	   ...
	   driver.findElement(By.xpath("(//mat-icon[@svgicon='down'])[3]")).click();
